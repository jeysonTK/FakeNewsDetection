...
#				8 = percentage	9 = clean			10= Filename for processed data	
init_data = Init()
...
def switch(argument):
	if argument == "TEST_ML":
		...
		dataset_statistics(init_data[3],init_data[4],init_data[5],init_data[6],init_data[7],init_data[8],init_data[9],init_data[10]);
